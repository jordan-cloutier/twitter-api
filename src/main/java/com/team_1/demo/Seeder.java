...
//
//import com.team_1.demo.entities.*;
//import com.team_1.demo.repositories.*;
//
...
//        user1.setLiked_tweets(user3Tweets);
//        userRepository.saveAndFlush(user1);
//
//        user2.setLiked_tweets(user1Tweets);
//        user2.setLiked_tweets(user2Tweets);
//        userRepository.saveAndFlush(user2);
//
//        user3.setLiked_tweets(user2Tweets);
//        userRepository.saveAndFlush(user3);
//
//        deletedUser.setLiked_tweets(user2Tweets);
